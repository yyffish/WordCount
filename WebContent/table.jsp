					...
					<ul id="sidebarnav">
						<li><a class="waves-effect waves-dark"
							href="table-basic.html" aria-expanded="false"><i
								class="fa fa-table"></i><span class="hide-menu">文件夹目录</span></a></li>
					</ul>
				</nav>
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">文件夹路径</h3>
						<ol class="breadcrumb">
						</ol>
					</div>
				</div>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											<c:forEach items="${folder.fileList }" var="file"
												varStatus="vs">
												<tr>
													<td><i class="fa fa-file-code-o"></i></td>
													<td><a href="count?path=${folder.path }${file }">${file }</a></td>
												</tr>
											</c:forEach>
											<c:forEach items="${folder.folderList }" var="folders"
												varStatus="vs">
												<tr>
													<td><i class="fa fa-folder-o"></i></td>
													<td><a href="main?path=${folder.path }${folders }">${folders }</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
